...
const nodeFetch = require('node-fetch'); // Đã đổi tên biến từ 'fetch' thành 'nodeFetch'
...
app.post('/giai-ma', async (req, res) => {
    ...
    try {
        ...
        // Debugging: Kiểm tra kiểu của nodeFetch trước khi gọi
        console.log('Type of nodeFetch before call:', typeof nodeFetch); 

        const verificationResponse = await nodeFetch(recaptchaVerificationUrl, { // Sử dụng 'nodeFetch'
            method: 'POST',
